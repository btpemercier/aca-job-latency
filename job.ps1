...
$containerImageName = "$($ProjectName.ToLower())-job"
...
New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateFile .\job.bicep -TemplateParameterObject @{ projectName = $ProjectName }